...
form_window = uic.loadUiType('./calculator2.ui')[0]
...
class Exam(QWidget, form_window):
    def __init__(self):
        ...
        btn_ops = [self.btn_add, self.btn_sub,self.btn_div,self.btn_mul]
    ...
    def calculator_init(self):
        self.first_input_flag = True
        self.opcode_input_flag = False  #opcode가 입력되면 바뀜.
        self.opcode = ''
        self.number1 = 0
    ...
    def btn_op_clicked_slot(self):
        ...
        #self.opcode_input_flag = True #  self.first_input_flag = True과 같은 것이야. 그러니까 없어도 돼
        self.first_input_flag = True
        print(self.number1)
        print(self.opcode)
